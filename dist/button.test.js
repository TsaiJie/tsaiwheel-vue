...
describe('Button', function () {
  ...
  it('可以设置icon.', function () {
    //把Button变成构造函数
    var Constructor = _vue.default.extend(_button.default); // 传入参数，并且挂载到内存
    ...
    expect(useElement.getAttribute('xlink:href')).to.equal('#i-settings'); // 从内存中删除
  ...
  it('icon 默认的 order 是 1', function () {
    ...
    var icon = vm.$el.querySelector('svg'); // getComputedStyle是一个可以获取当前元素所有最终使用的CSS属性值。返回的是一个CSS样式声明对象([object CSSStyleDeclaration])
